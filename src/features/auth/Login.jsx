                ...
                <div className="relative z-10 w-full h-full p-16 flex flex-col justify-start">
                    ...
                    <div className="space-y-6 mt-32">
                        ...
                        <div className="grid grid-cols-2 gap-6 pt-8">
                            {iconAndLabels.map((highlightItem, highlightIndex) => (
                                <div 
                                    key={highlightIndex} 
                ...
                <div className="w-full max-w-[440px] space-y-8 animate-in fade-in slide-in-from-right-4 duration-700">
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between ml-1">
                                <label className="text-[13px] font-black text-slate-500 capitalize tracking-wide">
                                    Password
                                </label>
                                <button 
                                    type="button" 
                    ...
                    <div className="pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
                        <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">
                            ...
                            <Link 
                                to="/register" 
                                className="text-primary-600 hover:text-primary-500 font-black capitalize transition-colors hover:underline"
                            >
                                Register Now
                            </Link>
                        </p>
