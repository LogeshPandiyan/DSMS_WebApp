                ...
                <div className="relative z-10 w-full h-full p-16 flex flex-col justify-start">
                    ...
                    <div className="space-y-6 mt-32">
                        <h1 className="text-5xl font-black text-white leading-tight tracking-tight">
                            Begin Your <br />
                            <span style={{ color: brandColor }}>Digital Journey.</span>
                        </h1>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16">
                <div className="w-full max-w-[440px] space-y-8 animate-in fade-in slide-in-from-right-4 duration-700">
                    <div className="space-y-2">
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight capitalize">Complete Setup</h2>
                        <p className="text-slate-500 dark:text-slate-400 font-medium capitalize">Create a secure password to activate your account.</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-[13px] font-black text-slate-500 capitalize tracking-wide ml-1">New Password</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-[13px] font-black text-slate-500 capitalize tracking-wide ml-1">Confirm Password</label>
                            <div className="relative group">
                                <input
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    <span className="capitalize tracking-wide">Set Password & Activate</span>
