        ...
        <div className="space-y-10 max-w-2xl animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="space-y-1">
                ...
                <p className="text-sm text-slate-500 font-medium">
                    Protect your account and e-signature credentials.
                </p>
            </div>
            ...
            >
                <div className="grid gap-6">
                    {PASSWORD_FIELD_CONFIGS.map((passwordField) => (
                        <div 
                            key={passwordField.id} 
                            className="space-y-2"
                        >
                            <label className="text-[11px] font-medium tracking-widest text-slate-400 ml-1">
                                {passwordField.label}
                            </label>
                            <div className="relative">
                                <input
                                    type={showPassword[passwordField.field] ? "text" : "password"}
                                    required
                                    value={passwords[passwordField.field]}
                                    onChange={(event) => setPasswords({
                                        ...passwords, 
                                        [passwordField.field]: event.target.value
                                    })}
                                ...
                                >
                                    {showPassword[passwordField.field] ? (
